...
| Choice | Value | Why |
|---|---|---|
| **Corpus** | Run 1: classroom sentences only. Run 2: the same plus 1,418 generated teaching passages | The corpus is the *only* difference between the two runs, so any change in the exam has one candidate cause |
